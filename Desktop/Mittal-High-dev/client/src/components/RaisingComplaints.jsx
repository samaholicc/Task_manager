...
function RaisingComplaints() {
  ...
  const raiseComplaint = async () => {
    try {
      ...
      if (res.status === 200) {
        toast.success("Plainte enregistrée"); // Translated "Complaint Raised" to "Plainte enregistrée"
        blockEl.current.value = "";
        roomEl.current.value = "";
        descpEl.current.value = "";
        tenantEl.current.value = "";
      } else {
        toast.info("Erreur : " + res.message); // Translated "Error" to "Erreur"
      }
    } catch (err) {
      console.log(err);
      toast.error("Erreur : " + err.message); // Translated "Error" to "Erreur"
    }
  };
      ...
      <div className="h-screen flex flex-wrap justify-center items-center md:px-20">
        <div className="card overflow-hidden px-6 py-10 max-w-2xl mx-auto">
          <h1 className="text-center text-2xl font-bold text-gray-500 mb-10">
            Ajouter une plainte {/* Translated "Add Complaint" to "Ajouter une plainte" */}
          </h1>
          <div>
            <label
              htmlFor="room-no"
            ...
            <div>
              ...
              >
                Numéro de bloc : {/* Translated "Block no:" to "Numéro de bloc :" */}
              </label>
              <input
                ref={blockEl}
                type="text"
                ...
                placeholder="Numéro de bloc" // Translated "Block no" to "Numéro de bloc"
                id="block-no"
            ...
            <div>
              <label
                ...
                className="my-2 font-semibold text-gray-500 text-lx font-serif"
              >
                Identifiant locataire : {/* Translated "Tenant Id:" to "Identifiant locataire :" */}
              </label>
              <input
                ref={tenantEl}
                type="text"
                ...
                placeholder="Identifiant locataire" // Translated "Tenant id" to "Identifiant locataire"
                id="tenant-no"
          ...
          <div className="space-y-4">
            ...
            >
              Description : {/* Translated "Description:" to "Description :" */}
            </label>
            <textarea
              ref={descpEl}
              id="description"
              ...
              rows="3"
              value={descp}
              placeholder="Écrivez ici..." // Translated "Write here.." to "Écrivez ici..."
